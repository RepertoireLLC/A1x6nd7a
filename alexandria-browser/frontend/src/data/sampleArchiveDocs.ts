...
export const SAMPLE_ARCHIVE_DOCS: ArchiveSearchDoc[] = [
  {
    identifier: "waybackmachine",
    title: "Internet Archive Wayback Machine",
    description:
      "Explore archived versions of websites captured by the Internet Archive's Wayback Machine. Includes billions of web pages dating back to 1996.",
    mediatype: "web",
    year: "2024",
    date: "2024-01-12",
  ...
  },
  {
    ...
    description:
      "A curated set of public domain ebooks hosted on the Internet Archive, covering literature, reference works, and historical texts.",
    mediatype: "texts",
    year: "2023",
    date: "2023-08-01",
  ...
  },
  {
    ...
    description:
      "Audio recordings from the Naropa University audio archive featuring lectures, readings, and discussions with prominent poets.",
    mediatype: "audio",
    year: "2019",
    date: "2019-05-14",
  ...
  },
  {
    ...
    description:
      "Historic films, commercials, and home movies digitized by the Prelinger Archives with a focus on ephemeral cultural artifacts.",
    mediatype: "movies",
    year: "2018",
    date: "2018-11-09",
  ...
  },
  {
    ...
    description:
      "High-resolution images released by the Smithsonian Institution covering art, history, science, and culture for open reuse.",
    mediatype: "image",
    year: "2020",
    date: "2020-02-25",
  ...
  },
  {
    ...
    description:
      "Playable software titles from the MS-DOS era preserved and emulated in the browser, including classic adventure and action games.",
    mediatype: "software",
    year: "2017",
    date: "2017-10-06",
  ...
  },
  {
    ...
    description:
      "Datasets collected by volunteers digitizing historical climate observations for research and long-term trend analysis.",
    mediatype: "data",
    year: "2016",
    date: "2016-04-18",
  ...
  },
  {
    ...
    description:
      "Clips from major television networks covering the 2020 United States elections, searchable by transcript and broadcast date.",
    mediatype: "tvnews",
    year: "2020",
    date: "2020-11-03",
  ...
  },
  {
    ...
    description:
      "Community contributed music, podcasts, and soundscapes shared under Creative Commons licenses across the world.",
    mediatype: "audio",
    year: "2021",
    date: "2021-07-22",
  ...
  },
  {
    ...
    description:
      "Digitized volumes of the 1911 Encyclopedia Britannica featuring detailed entries across arts, sciences, and world history.",
    mediatype: "texts",
    year: "1911",
    date: "1911-01-01",
  ...
  },
  {
    ...
    description:
      "Correspondence and personal papers of George Washington digitized from the Library of Congress collection.",
    mediatype: "texts",
    year: "1776",
    date: "1776-12-25",
